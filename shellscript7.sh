...
# This command will search for lines containing the word "error" in the "app.log" file and display the matching lines along with the three lines that follow
grep -A 3 "error" app.log

# awk command to extract a specific column, -F is a field seperator
